    ...
    <div class="row" style="margin-top: 70px;">
        <div class="col-lg-12">
            <div class="panel panel-default siku">
                <a href="<?php echo base_url() . 'index.php/toko/tambah_spg' ?>" class="btn btn-info siku" role="button" style="margin: 10px;">Tambah SPG</a>
            </div>
        </div>
...
<!--                                <div class="panel-heading">
                                ...
                                <div class="panel-body">
                                    <div style="text-align: center;">
                                        <img src="<?php echo base_url() ?>uploads/<?php echo "a.jpg" ?>" alt="<?php echo "a.jpg" ?>" width="200" >
                                    </div>
                                    <br>
                                    <table>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="text-right">Gaji SPG :</td>
                                            <td><?php echo "gaji" ?></td>
                                        </tr>
                                    </table>
                                    <br>
                                    <div style="text-align: center">
                                        <a href='<?php echo base_url() ?>index.php/toko/tambah_spg/' class='btn btn-primary btn-sm siku'><i class='fa fa-pencil'></i></a>
                                        <a href='<?php echo base_url() ?>index.php/toko/delete_spg/' class='btn btn-danger btn-sm siku' onclick="return confirm('Are you sure you want to delete this item?');"><i class='fa fa-trash'></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
